...
if __name__ == "__main__":
    ...
    if (trainFlag):
        ...
        myGammaGWR.train(oDataSet, labelSet, maxEpochs=15, insertionT=0.85, beta=0.5, epsilon_b=0.2, epsilon_n=0.001)
    ...
    if (testFlag):
        ...
        accuracy = myGammaGWR.computeAccuracy(bmuLabel, labelSet)
