**GWR-Extensions for recognition tasks**

This repository contains a number of extensions of the Grow-When-Required (GWR) self-organizing neural network by Marsland et al. (2002)
